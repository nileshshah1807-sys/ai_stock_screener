...
DEFAULT_REPRODUCIBILITY_CONFIG_KEYS = (
    ...
    # Model 5.0 factor architecture.  These are all output- or
    # evidence-affecting inputs, including collection limits: partial statement
    # coverage changes which symbols can clear the factor coverage gate.
    "FACTOR_MODEL_ENABLED",
    "FACTOR_WEIGHT_QUALITY",
    "FACTOR_WEIGHT_GROWTH",
    "FACTOR_WEIGHT_VALUE",
    "FACTOR_WEIGHT_MOMENTUM",
    "FACTOR_WEIGHT_RISK",
    "FACTOR_GROWTH_FEATURE_WEIGHTS",
    "FACTOR_SECTOR_NEUTRAL",
    "FACTOR_MIN_SECTOR_PEERS",
    "FACTOR_WINSOR_LOWER_PCT",
    "FACTOR_WINSOR_UPPER_PCT",
    "FACTOR_VALUE_QUALITY_FLOOR_PCT",
    "FACTOR_VALUE_CEILING_WHEN_LOW_QUALITY",
    "FACTOR_MIN_BLOCK_COVERAGE",
    "FACTOR_SCORE_AS_PERCENTILE",
    ...
    "MARKET_REGIME_MA_SESSIONS",
    "MARKET_REGIME_SLOPE_SESSIONS",
    "MARKET_REGIME_NEUTRAL_BAND_PCT",
    "REGIME_RISK_OFF_DISABLES_STRONG_BUY",
    "REGIME_RISK_OFF_MIN_MOMENTUM_PCT",
    ...
    "FACTOR_FUNDAMENTAL_MIN_COVERAGE_FOR_BUY",
    "FACTOR_TECHNICAL_MIN_COVERAGE_FOR_BUY",
    "REQUIRE_LIQUIDITY_FOR_BUY",
    "FACTOR_FINANCIAL_STATEMENT_QUALITY_SUFFICIENT",
    "RANK_BY_ELIGIBILITY_CLASS",
    "STATEMENT_COLLECTION_ENABLED",
    "STATEMENT_CACHE_MAX_AGE_DAYS",
    "STATEMENT_FETCH_MAX_SYMBOLS_PER_RUN",
    "FACTOR_MIN_STATEMENT_UNIVERSE_COVERAGE",
    "STATEMENT_REQUESTS_PER_MINUTE",
    "STATEMENT_MIN_YEARS_FOR_CAGR",
